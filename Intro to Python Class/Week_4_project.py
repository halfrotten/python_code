...
def  Yard():
    ...
    Discount(cost)
#service involves mowing, edging and shrub pruning.
#The cost of the mowing depends upon the square footage of the yard, the cost of edging
#depends upon the linear footage of the yard's edges and the cost of shrub pruning depends upon the number of shrubs.
